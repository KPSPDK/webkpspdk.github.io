...
$subject ="Новая заявка с сайта kpspdk";
...
$header .= "From: Новая заявка <t3stovtesttestov@yandex.ru>\n\n";	
$mail = mail("t3stovtesttestov@yandex.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
